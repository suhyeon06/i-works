...
public class FileUtils {
     ...
     */
    public List<FileUploadRequestDto> uploadFiles(final List<MultipartFile> multipartFiles) {
     ...
     */
    public FileUploadRequestDto uploadFile(final MultipartFile multipartFile) {
